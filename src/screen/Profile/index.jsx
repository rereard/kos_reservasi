        ...
        <ScrollView>
          <View style={{ margin: 20 }}>
            <Text style={[styles.textHeader(colors.black), { marginBottom: 10 }]}>
              <Ionicons name='md-person-outline' style={{ fontSize: 18, color: colors.darkBlue }} /> My Profile
            </Text>
            <View style={styles.profileBox}>
              <View style={styles.profile}>
                ...
                <View style={{ justifyContent: "center" }}>
                  <Text style={styles.textHeader(colors.black)}>{user?.firstName} {user?.lastName}</Text>  
                  <Text style={[styles.text(colors.darkGrey), { marginVertical: 3 }]}>@{user?.username}</Text>
                  <Text style={ styles.text(colors.darkGrey) }>{user?.email}</Text>        
                </View>
              </View>
    ...
    return(
      <SafeAreaView style={{ flex: 1, margin: 20 }}>
        <View style={[styles.profileBox, { marginBottom: 10 }]}>
          <Text style={[styles.textHeader(colors.black), { marginBottom: 5 }]}>My Profile</Text>
          <Text style={styles.text(colors.black)}>Sign in to see your account's profile</Text>
        </View>
        <Button title="Sign in" color={colors.darkBlue} onPress={() => navigation.navigate("Sign")} />
      </SafeAreaView>
    )
  }
}
